...
export default function Home() {
  ...
  return (
    <div className={darkMode ? "dark max-w-6xl mx-auto" : "max-w-6xl mx-auto"}>
      <Head>
        ...
        <Fade top distance="5%" duration={1500}>
          <section className="pb-10 px-10 md-px-20 lg:px-40">
            ...
            <div className="text-center">
              <h2 className="text-5xl py-2 font-medium md:text-6xl dark:text-white">Jake Dawson</h2>
          ...
          <section className="py-10 px-10 md-px-20 lg:px-40">
            ...
            <div className="py-10">
              <InfiniteLooper>
                  <Image src={php} className="p-5 m-2 h-36 w-36" />
                  <Image src={java} className="p-5 m-2 h-36 w-36" />
                  <Image src={javascript} className="p-5 m-2 h-36 w-36" />
                  <Image src={reactImg} className="p-5 m-2 h-36 w-36" />
                  <Image src={angular} className="p-5 m-2 h-36 w-36" />
                  <Image src={android} className="p-5 m-2 h-36 w-36" />
                  <Image src={mysql} className="p-5 m-2 h-36 w-36" />
                  <Image src={firebase} className="p-5 m-2 h-36 w-36" />
              </InfiniteLooper>
            </div>
          </section>
